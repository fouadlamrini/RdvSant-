...
<body class="bg-gray-100">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <aside class="bg-gray-900 text-white w-full md:w-64 p-4 space-y-4">
            ...
            <nav class="space-y-2">
                <a href="#" class="block bg-blue-600 p-2 rounded">Projets</a>
                <a href="#" class="block bg-blue-600 p-2 rounded">Categories</a>
                <a href="#" class="block bg-blue-600 p-2 rounded">Sous-Categories</a>
                <a href="#" class="block bg-blue-600 p-2 rounded">Freelances</a>
                <a href="#" class="block bg-blue-600 p-2 rounded">Offres</a>
