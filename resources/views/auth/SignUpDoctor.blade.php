...
<body class="flex flex-col min-h-screen">
 ...
 <nav class="bg-black text-white shadow-md">
  ...
  <!-- end navbar -->
    ...
    <!-- Main Content -->
    <div class="flex items-center justify-center flex-grow bg-[url('/images/360_F_424309320_UkOxg2z3sq7yXwGnWCO6xBXkRI4byhnI.jpg')] bg-cover bg-center">
        ...
        <div class="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden w-11/12 sm:w-5/6 lg:w-3/4 max-w-4xl mx-4 my-8">
            ...
            <div class="hidden md:block md:w-1/2 lg:w-2/5">
                <img src="{{ asset('images/pngtree-handsome-young-male-doctor-in-white-uniform-with-stethoscope-png-image_15738886.png') }}" alt="Doctor"
